...
public class MasterService : IMasterService
{
    ...
    public Task<ApiResult> GetCustomersAsync(int? companyId) => _repo.GetCustomersAsync(companyId);
    public Task<ApiResult> InsertCustomerAsync(CustomerModel model) => _repo.InsertCustomerAsync(model);
    public Task<ApiResult> GetCustomerByMobileAsync(string mobile, int? companyId) => _repo.GetCustomerByMobileAsync(mobile, companyId);
